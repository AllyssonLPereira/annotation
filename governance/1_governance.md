...
Ela demonstra a responsabilidade e supervisiona para garantir que os riscos sejam adequadamente mitigados e que as estratégias de segurança estejam alinhadas aos objetivos comerciais da empresa e estejam em conformidade com as regulamentações.
...
Há várias funções importantes em bons programas de administração de dados, são elas:
...
Uma política de segurança digital é um *documento* de alto nível que descreve a visão de uma empresa sobre segurança digital, incluindo suas metas, necessidades, escopo e responsabilidades. 
...
- *Política específica do sistema*
	...
	Esse tipo de política é desenvolvido para dispositivos ou sistemas de computador específicos e tem como objetivo estabelecer a padronização para aplicações aprovadas, software, configurações de sistema operacional, contramedidas de hardware e proteção dentro de uma empresa.
