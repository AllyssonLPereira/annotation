...
O SCADA e outros sistemas de controle industrial — *`ICS's`* — são usados nos sistemas de manufatura, produção, energia e comunicação.

Agora, como os ataques digitais como esses podem afetar os setores da indústria e quais ações podem ser tomadas para impedir que esses ataques ocorram?
