...
- ##### Armazenamento criptografado
	...
	A criptografia de armazenamento de dados Apple Data Protection e FileVault é compatível com o mecanismo de criptografia AES de hardware. 

	Isso permite a criptografia e a descriptografia de arquivos à medida que eles são gravados ou lidos, sem expor as chaves de criptografia para a CPU principal, sistema operacional ou aplicativos em execução.
